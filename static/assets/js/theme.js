...
var utils = {
  ...
  getPastHourInMinutes: getPastHourInMinutes,
  getMinutes: getMinutes,
  formatBytes: formatBytes,
  formatBitsPerSecond: formatBitsPerSecond,
  convertEpochToDateTime: convertEpochToDateTime,
...
var leafletTopologyInit = function leafletTopologyInit() {
  var points = JSON.parse(selected_peers_geo_data);
  var selected_node_point = JSON.parse(selected_node_geo_data);

  if (JSON.parse(selected_node_geo_data).length < 1) { 
    selected_node_point = [{"name": "undefined-location-name", "location": "Location not found", "lat": "-26.0196737", "long": "+28.0665239", "ip": ""}]
  }
  var _window2 = window,
      L = _window2.L;
  var mapContainer = document.getElementById('topology-map');
  ...
  if (L && mapContainer) {
    ...
    var map = L.map('topology-map', {
      center: L.latLng(selected_node_point[0]["lat"], selected_node_point[0]["long"]),
      zoom: 10,
      layers: [tiles],
      minZoom: 2,
      zoomSnap: 0.5,
    ...
    var selected_node_icon = L.icon({
      iconAnchor: [50,50],
      iconUrl: "data:image/png;base64,"
    });
    var selected_node_marker = L.marker(new L.LatLng(selected_node_point[0]["lat"], selected_node_point[0]["long"]), {
      icon: selected_node_icon,
      title: selected_node_point[0]["name"]
    }, {
      name: selected_node_point[0]["name"],
      location: selected_node_point[0]["location"]
    }).addTo(map)
    .bindPopup("\n        <h6 class=\"mb-1\">".concat(selected_node_point[0]["name"], "</h6>\n        <p class=\"m-0 text-500\">").concat(selected_node_point[0]["location"], "</p>\n      ").concat("<p class=\"m-0\">", "<span class='fs--2 mb-0 ms-2 text-success'>Selected Router</span>", "</p>"))
    ...
    points.map(function (point) {
      ...
      var icon = L.icon({
        ...
        iconUrl: "data:image/png;base64,",
        iconAnchor: [40,40],
      });

      if(status=='RUNNING'){
        var status_span='<span class="fs--2 mb-0 ms-2 text-success">'+status+'</span>';
        var icon_html='<div class="gps_ring_green"><img src="data:image/png;base64,"/></div>'
        var path_status_color="#5cb85c"
      }else if(status=='UNKNOWN'){
        var status_span='<span class="fs--2 mb-0 ms-2 text-warning">'+status+'</span>';
        var icon_html='<div class="gps_ring_amber"><img src="data:image/png;base64,"/>'
        var path_status_color="#f0ad4e"
      }else{
        var status_span='<span class="fs--2 mb-0 ms-2 text-danger">'+status+'</span>';
        var icon_html='<div class="gps_ring_red"><img src="data:image/png;base64,"/></div>'
        var path_status_color="#d9534f"
      } 
      ...
      // L.marker(new L.LatLng(point["lat"], point["long"]), {icon: cssIcon}).addTo(map).on('click', clickZoom);

      var popupContent = "\n        <h6 class=\"mb-1\">".concat(name, "</h6>\n        <p class=\"m-0 text-500\">").concat(location, "</p>\n      ").concat("<p class=\"m-0\">", ip, "</p>").concat("<p class=\"m-0\">", status_span, "</p>");
      var popup = L.popup({
        minWidth: 180
      ...
      var path_coordinates = [
                      [selected_node_point[0]["lat"], selected_node_point[0]["long"]],
                      [point["lat"], point["long"]]
                    ];       
      var path = L.polyline(path_coordinates, {"delay":400,"weight":1,"color":path_status_color,"paused":true,"reverse":false}
      ).addTo(map); // "dashArray":[10,20]
    ...
    markers.push(selected_node_marker);
    // map.addLayer(mcg);
    var themeController = document.body;
...
var leafletActiveUserInit = function leafletActiveUserInit() {
  var points = JSON.parse(node_geo_data);
  ...
  if (L && mapContainer) {
    ...
    points.map(function (point) {
      ...
      var popupContent = "\n        <h6 class=\"mb-1\">".concat(name, "</h6>\n        <p class=\"m-0 text-500\">").concat(location, "</p>\n      ", "<a class='text-primary fw-semi-bold' href='/page/topology/?router_select="+name +"'>Go to Topology</a>");
      var popup = L.popup({
        minWidth: 180
      }).setContent(popupContent);
      marker.bindPopup(popup);
...
var audienceChartInit = function audienceChartInit() {
  var data = {
    dates: utils.getPastHourInMinutes('half-hour'),
    dataset: {
      bandwidth: JSON.parse(peer_path_bandwidth_data),
      latency: JSON.parse(peer_path_latency_data),
      loss: JSON.parse(peer_path_packet_loss_data),
      jitter: JSON.parse(peer_path_jitter_data),
    }
  };
  var tab_key;

  var get_units_of_measure = function get_units_of_measure(value) {
        var measurement;
        ...
        switch (tab_key) {
          ...
          case 'bandwidth':
            measurement = utils.formatBitsPerSecond(value);
            break;                            
  ...
  var tooltipFormatter = function tooltipFormatter(params) {
    ...
    var uom = get_units_of_measure(params[0].data);  
    var measurement;
    if (tab_key) {
        measurement=tab_key;
     } else {
  ...
  var getDefaultOptions = function getDefaultOptions(data1, data2, key) {
    return function () {
      return {
        ...
        xAxis: {
          type: 'category',
          /* data: data.dates, */
          data:utils.convertEpochToDateTime(data2),
          axisLabel: {
            color: utils.getGrays()['600'],
            formatter: function formatter(value) {
              return window.dayjs(value).format('MMM D, YYYY h:mm A');
            },
            align: 'left',
            fontSize: 11,
            padding: [0, 0, 0, 5],
        ...
        yAxis: {
          ...
          axisLabel: {
            ...
            formatter: function formatter(value) {
                var measurement;
                console.log('switch_tab_key:', tab_key)
                switch (tab_key) {
                  case 'jitter':
                    measurement = value+' ms';
                    break;
  ...
  if (tab) {
    initChart(document.querySelector('.echart-audience'), getDefaultOptions(data.dataset.bandwidth[0], data.dataset.bandwidth[1]), 'bandwidth');
    var triggerTabList = Array.from(tab.querySelectorAll('[data-bs-toggle="tab"]'));
    triggerTabList.forEach(function (triggerEl) {
      triggerEl.addEventListener('shown.bs.tab', function () {
        var key = triggerEl.href.split('#').pop();
        console.log('tab_key: ', key)
        tab_key=key;
        var $echartAudience = document.getElementById(key).querySelector('.echart-audience');
        initChart($echartAudience, getDefaultOptions(data.dataset[key][0], data.dataset[key][1]), key);
      });
    });
  }
...
var realTimeUsersChartInit = function realTimeUsersChartInit() {
  ...
  if ($echartsRealTimeUsers) {
    ...
    var data = [921, 950, 916, 913, 909, 962, 926, 936, 977, 976, 999, 981, 998, 999, 920, 906, 973, 911, 994, 982, 917, 972, 952, 963, 909];
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        ...
        yAxis: {
          ...
          min: 0,
          max: Math.floor(parseFloat($('#router-bandwidth-in-bps').text())*1.1)
        },
        series: [{
          type: 'bar',
          barCategoryGap: '12%',
    ...
    setInterval(function () {
      ...
      var rndData = Math.floor(parseFloat($('#router-bandwidth-in-bps').text()));
      data.shift();
      data.push(rndData);
      axisData.shift();
      axisData.push(utils.getRandomNumber(100, 500));
      userCounterDom.innerHTML = $('#router-bandwidth').text();
      chart.setOption({
        xAxis: {
          data: axisData
        },
...
/*                                Top Sessions By Service                     */

/* -------------------------------------------------------------------------- */

var topSessionsChartInit = function topSessionsChartInit() {
  var $topSessions = document.querySelector('.echart-top-sessions');

  if ($topSessions) {
    var userOptions = utils.getData($topSessions, 'options');
    var chart = window.echarts.init($topSessions);
    var dataset = {
      week: [{
        value: 50.3,
        name: 'Chrome'
    ...
    echartSetOption(chart, userOptions, getDefaultOptions);
    var selectMenu = document.querySelector("[data-target='.echart-top-sessions']");
...
var sessionByBrowserChartInit = function sessionByBrowserChartInit() {
  ...
  if ($sessionByBroswser) {
    ...
    $.each(JSON.parse(top_sources_dataset), function (i, val) {
        dataset.week[i].value = val.value;
        dataset.week[i].name = val.name;
    });

    
    var getDefaultOptions = function getDefaultOptions() {
      return {
        color: [utils.getColors().primary, utils.getColors().danger, utils.getColors().success, utils.getColors().secondary, utils.getColors().warning, ],
        tooltip: {
          trigger: 'item',
          padding: [7, 10],
          backgroundColor: utils.getGrays()['100'],
          ...
          transitionDuration: 0,
          formatter: function formatter(params) {
            return "<strong>".concat(params.data.name, ":</strong> ").concat( utils.formatBytes(params.data.value), "");
          },
          position: function position(pos, params, dom, rect, size) {
            return getPosition(pos, params, dom, rect, size);
          }
