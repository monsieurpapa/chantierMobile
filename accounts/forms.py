...
class UserCreateForm(forms.ModelForm):
    """Admin form for creating a brand-new user — superadmin only.

    No password field: a random temporary password is generated by the
    view and shown once to the superadmin, with must_change_password
    forced on so the new user sets their own password on first login
    (same convention as bootstrap_admin_and_roles).
    """
    ...
    username = forms.CharField(
        ...
        help_text=_('Used to log in. Letters, digits and @/./+/-/_ only.')
    )
    ...
    is_active = forms.BooleanField(
        ...
        help_text=_('Uncheck to create the account already deactivated')
    )
